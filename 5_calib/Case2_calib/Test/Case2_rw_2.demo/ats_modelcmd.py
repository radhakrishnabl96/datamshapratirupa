...
file_name = 'Case2' # Change
line_por_peat = 596 # Change (-1 of the line where porosity of peat is found)
line_por_mineral = 605 # Change (-1 of the line where porosity of mineral is found)
