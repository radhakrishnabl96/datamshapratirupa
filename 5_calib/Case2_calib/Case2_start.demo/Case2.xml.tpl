...
<ParameterList name="Main" type="ParameterList">
  ...
  <ParameterList name="PKs" type="ParameterList">
    ...
    <ParameterList name="subsurface flow" type="ParameterList">
      ...
      <ParameterList name="initial condition" type="ParameterList">
        <Parameter name="restart file" type="string" value="../../../3_spinup/Case2_dynamic_spinup.demo/checkpoint_final.h5" />
      </ParameterList>
      ...
      <ParameterList name="water retention evaluator" type="ParameterList">
        ...
        <ParameterList name="WRM parameters" type="ParameterList">
          ...
          <ParameterList name="mineral" type="ParameterList">
            ...
            <Parameter name="van Genuchten n [-]" type="double" value="2.03478" />
            <Parameter name="residual saturation [-]" type="double" value="0.276669" />
            <Parameter name="smoothing interval width [saturation]" type="double" value="0.1" />
          </ParameterList>
        ...
        <ParameterList name="temperature" type="ParameterList">
          <ParameterList name="bottom" type="ParameterList">
            ...
            <ParameterList name="boundary temperature" type="ParameterList">
              <ParameterList name="function-constant" type="ParameterList">
                <Parameter name="value" type="double" value="#b_bc         #" />
              </ParameterList>
            </ParameterList>
          </ParameterList>
        </ParameterList>
      ...
      <ParameterList name="thermal conductivity evaluator" type="ParameterList">
        <ParameterList name="thermal conductivity parameters" type="ParameterList">
          <ParameterList name="peat" type="ParameterList">
            ...
            <Parameter name="thermal conductivity, saturated (unfrozen) [W m^-1 K^-1]" type="double" value="0.769259" />
            <Parameter name="thermal conductivity, dry [W m^-1 K^-1]" type="double" value="0.115755" />
            <Parameter name="unsaturated alpha frozen [-]" type="double" value="0.91046" />
            <Parameter name="unsaturated alpha unfrozen [-]" type="double" value="0.121734" />
          </ParameterList>
          <ParameterList name="mineral" type="ParameterList">
            <Parameter name="region" type="string" value="subsurface domain mineral" />
            <Parameter name="thermal conductivity type" type="string" value="three-phase wet/dry" />
            <Parameter name="thermal conductivity, saturated (unfrozen) [W m^-1 K^-1]" type="double" value="0.238026" />
            <Parameter name="thermal conductivity, dry [W m^-1 K^-1]" type="double" value="1.14508" />
            <Parameter name="unsaturated alpha frozen [-]" type="double" value="1.66879" />
            <Parameter name="unsaturated alpha unfrozen [-]" type="double" value="1.15541" />
          </ParameterList>
          <ParameterList name="bedrock" type="ParameterList">
            <Parameter name="region" type="string" value="subsurface domain bedrock" />
            <Parameter name="thermal conductivity type" type="string" value="three-phase wet/dry" />
      ...
      <ParameterList name="density_rock" type="ParameterList">
        ...
        <ParameterList name="function" type="ParameterList">
          <ParameterList name="peat" type="ParameterList">
            ...
            <ParameterList name="function" type="ParameterList">
              <ParameterList name="function-constant" type="ParameterList">
                <Parameter name="value" type="double" value="9.0000000E+02" />
              </ParameterList>
            </ParameterList>
          </ParameterList>
          <ParameterList name="mineral" type="ParameterList">
            ...
            <ParameterList name="function" type="ParameterList">
              <ParameterList name="function-constant" type="ParameterList">
                <Parameter name="value" type="double" value="1.9000000E+03" />
              </ParameterList>
            </ParameterList>
          </ParameterList>
          <ParameterList name="bedrock" type="ParameterList">
          ...
          <ParameterList name="domain" type="ParameterList">
            ...
            <ParameterList name="function" type="ParameterList">
              <ParameterList name="function-tabular" type="ParameterList">
                <Parameter name="file" type="string" value="../../../1_data_prep/Final_InputData_4yrs/Calib_data_2016_2018.h5" />
    ...
    <ParameterList name="initial conditions" type="ParameterList">
      ...
      <ParameterList name="land cover types" type="ParameterList">
        <ParameterList name="surface domain" type="ParameterList">
          ...
          <Parameter name="water transition depth [m]" type="double" value="0.0025" />
          <Parameter name="albedo of bare ground [-]" type="double" value="0.151477" />
          <Parameter name="emissivity of bare ground [-]" type="double" value="0.879419" />
        </ParameterList>
      </ParameterList>
  ...
  <ParameterList name="visualization" type="ParameterList">
    <ParameterList name="domain" type="ParameterList">
      <Parameter name="times start period stop 0" type="Array(double)" value="{0.0,100.,-1.0}" />
