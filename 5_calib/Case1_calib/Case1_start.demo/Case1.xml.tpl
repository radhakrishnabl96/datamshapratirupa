...
<ParameterList name="Main" type="ParameterList">
  ...
  <ParameterList name="PKs" type="ParameterList">
    ...
    <ParameterList name="flow" type="ParameterList">
      ...
      <ParameterList name="initial condition" type="ParameterList">
        <Parameter name="restart file" type="string" value="../../../3_spinup/Case1_dynamic_spinup.demo/checkpoint_final.h5" />
      </ParameterList>
          ...
          <ParameterList name="Top" type="ParameterList">
            ...
            <ParameterList name="boundary temperature" type="ParameterList">
              <ParameterList name="function-tabular" type="ParameterList">
                ...
                <!--<Parameter name="file" type="string" value="/home/rk/ats_rk/testing/ats-demos/rk_model/Data/Data_Yakou/Yakou_met_data_ITP_rk/Final_InputData_4yrs/Validation_data_2019.h5" /> -->
