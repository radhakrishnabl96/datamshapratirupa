...
<ParameterList name="Main" type="ParameterList">
  ...
  <ParameterList name="cycle driver" type="ParameterList">
    ...
    <Parameter name="end time" type="double" value="366" />
      ...
      <ParameterList name="water retention evaluator" type="ParameterList">
        ...
        <ParameterList name="WRM parameters" type="ParameterList">
          ...
          <ParameterList name="mineral" type="ParameterList">
            ...
            <Parameter name="van Genuchten n [-]" type="double" value="1.48459" />
            <Parameter name="residual saturation [-]" type="double" value="0.156116" />
            <Parameter name="smoothing interval width [saturation]" type="double" value="0.1" />
          </ParameterList>
      ...
      <ParameterList name="thermal conductivity evaluator" type="ParameterList">
        <ParameterList name="thermal conductivity parameters" type="ParameterList">
          <ParameterList name="peat" type="ParameterList">
            ...
            <Parameter name="thermal conductivity, saturated (unfrozen) [W m^-1 K^-1]" type="double" value="0.491955" />
            <Parameter name="thermal conductivity, dry [W m^-1 K^-1]" type="double" value="0.120658" />
            <Parameter name="unsaturated alpha frozen [-]" type="double" value="1.49655" />
            <Parameter name="unsaturated alpha unfrozen [-]" type="double" value="0.477138" />
          </ParameterList>
          <ParameterList name="mineral" type="ParameterList">
            <Parameter name="region" type="string" value="subsurface domain mineral" />
            <Parameter name="thermal conductivity type" type="string" value="three-phase wet/dry" />
            <Parameter name="thermal conductivity, saturated (unfrozen) [W m^-1 K^-1]" type="double" value="0.938164" />
            <Parameter name="thermal conductivity, dry [W m^-1 K^-1]" type="double" value="0.9844" />
            <Parameter name="unsaturated alpha frozen [-]" type="double" value="1.49909" />
            <Parameter name="unsaturated alpha unfrozen [-]" type="double" value="0.6992" />
          </ParameterList>
          <ParameterList name="bedrock" type="ParameterList">
            <Parameter name="region" type="string" value="subsurface domain bedrock" />
            <Parameter name="thermal conductivity type" type="string" value="three-phase wet/dry" />
      ...
      <ParameterList name="density_rock" type="ParameterList">
        ...
        <ParameterList name="function" type="ParameterList">
          <ParameterList name="peat" type="ParameterList">
            ...
            <ParameterList name="function" type="ParameterList">
              <ParameterList name="function-constant" type="ParameterList">
                <Parameter name="value" type="double" value="9.0000000000e+02" />
              </ParameterList>
            </ParameterList>
          </ParameterList>
          <ParameterList name="mineral" type="ParameterList">
            ...
            <ParameterList name="function" type="ParameterList">
              <ParameterList name="function-constant" type="ParameterList">
                <Parameter name="value" type="double" value="1.9000000000e+03" />
              </ParameterList>
            </ParameterList>
          </ParameterList>
          <ParameterList name="bedrock" type="ParameterList">
    ...
    <ParameterList name="initial conditions" type="ParameterList">
      ...
      <ParameterList name="land cover types" type="ParameterList">
        <ParameterList name="surface domain" type="ParameterList">
          ...
          <Parameter name="water transition depth [m]" type="double" value="   1.0000000E-02" />
          <Parameter name="albedo of bare ground [-]" type="double" value="       5.5000000E-01" />
          <Parameter name="emissivity of bare ground [-]" type="double" value="  5.5000000E-01" />
        </ParameterList>
      </ParameterList>
